--[[
Ghost Reaper, the Underworld Destroyer
DARK / Fiend / Effect
Level 4 / ATK 1500 / DEF 0

Effect:
When this card is Normal or Special Summoned: You can Special Summon 1 Fiend monster from your Deck in face-up Defense Position.
If this card is destroyed and sent to the GY: You can Special Summon this card during the End Phase.
--]]

local s,id=GetID()
function s.initial_effect(c)
	-- Special Summon from Deck on Normal/Special Summon
