--Alpha-Cyber Assault Overdrive
--Scripted by YourName
local s,id=GetID()
function s.initial_effect(c)
	--Synchro Summon procedure
	c:EnableReviveLimit()
	Synchro.AddProcedure(c,nil,1,1,Synchro.NonTuner(Card.IsRace,RACE_MACHINE),1,99)
	
	--Special Summon on Synchro Summon
...
function s.spfilter2(c,e,tp)
	return c:IsCode(33) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
